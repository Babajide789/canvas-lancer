        ...
        <div className="welcome-text space-y-6 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mt-8">
            <Link
              ...
              duration={600}
              offset={-70}
              className="px-6 sm:px-8 py-3 rounded-full bg-red-600 hover:bg-red-700 text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
              Hire Us
            </Link>
            ...
            <Link
              ...
              duration={600}
              offset={-70}
              className="px-6 sm:px-8 py-3 rounded-full border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
              View Portfolio
            </Link>
          </div>
