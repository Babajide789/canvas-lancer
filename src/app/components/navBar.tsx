      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden overflow-hidden bg-black/95 text-white px-6 py-4 space-y-4 text-center"
          >
            <Link href="/" className="block hover:text-red-600">Home</Link>
            <Link href="/about" className="block hover:text-red-600">About Us</Link>
            <Link href="/services" className="block hover:text-red-600">Services</Link>
            <Link href="/portfolio" className="block hover:text-red-600">Portfolio</Link>
            <Link href="/testimonies" className="block hover:text-red-600">Testimonies</Link>
            <Link href="/faq" className="block hover:text-red-600">Faqs</Link>
